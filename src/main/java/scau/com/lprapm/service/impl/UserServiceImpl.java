...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public int editPassword(String userNameInfo, String oldPassword, String newPassword) {
        return userMapper.editPassword(userNameInfo,oldPassword,newPassword);
    }
