...
//        产生验证码
    ...
    public JsonResult editPassword(@RequestParam("userNameInfo") String userNameInfo,@RequestParam("oldPassword") String oldPassword,@RequestParam("newPassword") String newPassword){
        JsonResult jsonResult=null;
        try {
                int result = userService.editPassword(userNameInfo,oldPassword,newPassword);
                jsonResult=new JsonResult(true,"结果",result);
        }catch (Exception e){
            e.printStackTrace();
            jsonResult=new JsonResult(false,e.getMessage());
        }
    ...
    public JsonResult getEmployee(){
        ...
        try {
            ...
            jsonResult = new JsonResult(total,true,"员工获取成功",employees);
        }catch (Exception e){
            e.printStackTrace();
            jsonResult=new JsonResult(false,e.getMessage());
        }
